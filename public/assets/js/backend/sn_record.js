define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sn_record/index' + location.search,
                    add_url: 'sn_record/add',
                    edit_url: 'sn_record/edit',
                    del_url: 'sn_record/del',
                    multi_url: 'sn_record/multi',
                    table: 'sn_record',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'is_bak', title: __('Is_bak'), searchList: {"0":__('Is_bak 0'),"1":__('Is_bak 1')}, formatter: Table.api.formatter.normal},
                        {field: 'bak_ftime', title: __('Bak_ftime'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime},
                        {field: 'bak_ctime', title: __('Bak_ctime'), operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime},
